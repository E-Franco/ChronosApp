...
class ReceberPagarWeekWidget extends StatefulWidget {
  @override
  _ReceberPagarWeekWidgetState createState() => _ReceberPagarWeekWidgetState();
}

class _ReceberPagarWeekWidgetState extends State<ReceberPagarWeekWidget> {
